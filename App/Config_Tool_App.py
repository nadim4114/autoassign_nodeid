...
class PyAUIFrame(wx.Frame):
    ...
    def __init__(self, parent, id=-1, title="", pos=wx.DefaultPosition,
        ...
        self.statusbar.SetStatusText("IO Module Configurator!", 1)
...
#                          Left().Layer(1).CloseButton(True).MaximizeButton(True))        
        ...
        self._mgr.AddPane(self.CreateTextCtrl(), aui.AuiPaneInfo().
                          Name("test10").Caption("Console Log").
    ...
    def OnAbout(self, event):
        ...
        msg = "Module Configurator\n" + \
              "An advanced IO Module configurator tool\n" + \
              "(c) Copyright 2023-2024, URA Systems"
        dlg = wx.MessageDialog(self, msg, "About software",
    ...
    def CreateTextCtrl(self):
        ...
        text = ("Event messages will appear here %d")%(self.n + 1)
